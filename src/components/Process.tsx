  ...
  return (
    <div className="relative py-20 bg-dark-surface overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute right-10 top-20 w-40 h-40 rounded-full bg-teal-700/10 filter blur-3xl"></div>
        <div className="absolute left-10 bottom-20 w-40 h-40 rounded-full bg-teal-900/10 filter blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {processes.map((process, index) => (
            ...
            >
              {/* Card number */}
              <div className="absolute -top-6 -left-2 w-12 h-12 flex items-center justify-center bg-teal-900 rounded-lg glow">
