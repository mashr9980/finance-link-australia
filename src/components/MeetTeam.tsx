            ...
            >
              <div className="dark-card rounded-xl overflow-hidden group">
                <div className="relative overflow-hidden pb-4">
                  ...
                  {/* Decorative border */}
                  <div className="absolute top-0 left-0 w-full h-full border-4 border-transparent group-hover:border-purple-500/30 transition-all duration-300 rounded-xl"></div>
