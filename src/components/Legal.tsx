      ...
      <div className="container mx-auto px-4 max-w-2xl">
        <div className={`space-y-6 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <Link to="https://fintelligence.com.au/privacy-policy/">
            <button
              type="button"
              className="dark-card w-full py-4 text-white rounded-xl transition duration-300 font-medium border border-purple-500/30 hover:border-purple-500/60 group relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-900/30 to-purple-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
