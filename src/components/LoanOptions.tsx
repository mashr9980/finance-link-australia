import car from "../components/assets/loan-icons/car-icon.svg"
import bike from "../components/assets/loan-icons/bike-motorcycle-icon.svg"
import caravan from "../components/assets/loan-icons/motor-home.png"
import boat from "../components/assets/loan-icons/rowing-icon.svg"
import jetSki from "../components/assets/loan-icons/jet-ski.png"
import web from "../components/assets/loan-icons/wedding-rings.png"
import holiday from "../components/assets/loan-icons/flight-ticket-icon.svg"
import truck from "../components/assets/loan-icons/truck-icon.svg"
import trailer from "../components/assets/loan-icons/flatbed-truck-icon.svg"
import tools from "../components/assets/loan-icons/tools-icon.svg"
import commercial from "../components/assets/loan-icons/residential.png"
import loan from "../components/assets/loan-icons/hand-money-income-note-icon.svg"
import draft from "../components/assets/loan-icons/investor-icon.svg"
...
export const businessLoanOptions = [
    ...
    {
        id: "Vending-finance",
        title: "Vending Finance",
        icon: commercial,
        description:
            "Build your vending machine empire with specialized financing. Australia's most experienced vending finance specialists with competitive rates and fast approvals.",
    },
    {
        id: "Trade-finance",
        title: "Trade Finance",
        icon: tools,
        description:
            "Specialized finance for tradies, self-employed, sole traders and ABN holders. Vehicle and machinery loans with approvals within 1 hour and no financials necessary.",
    },
];