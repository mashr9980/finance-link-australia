...
import vending from "../components/assets/scripts1.png"
...
export const pageConfigs: Record<string, PageConfig> = {
    ...
    "/business-loans/Vending-finance": {
        head: "Vending Finance Specialist",
        titleShort: "Build Your Vending Machine",
        titleLong: "Empire with Expert Financing!",
        image: [vending],
        text: "Finance Link Australia are the most experienced vending machine finance specialists in the industry. Get personalised quotes to build your vending empire with obligation-free enquiries that won't impact your credit file.",
        icons: [],
        overlay: false
    },
    "/business-loans/Trade-finance": {
        head: "Trade Finance Specialist",
        titleShort: "Linking Tradies to the Best",
        titleLong: "Finance Deals in the Country!",
        image: [Com],
        text: "Specialized finance for self-employed tradies, sole traders and ABN holders. Vehicle and machinery loans with approvals within 1 hour, no financials necessary, and credit score protection.",
        icons: [],
        overlay: false
    },
    "/vending-finance": {
...
export const loanConfigs: Record<string, LoanConfig> = {
    ...
    "/business-loans/Vending-finance": {
        titleShort: "Build your vending empire with",
        titleLong: "specialized vending machine financing!",
        textF: "As Australia's most experienced vending finance specialists, we offer competitive rates and fast approvals. Get personalized quotes with obligation-free enquiries.",
        textL: "From single machines to multi-location operations, we understand the vending industry and structure finance solutions that work for your business growth.",
        images: vending,
    },
    "/business-loans/Trade-finance": {
        titleShort: "Power your trade business with",
        titleLong: "specialized trade financing solutions!",
        textF: "Linking tradies to the best finance deals in the country. Approvals within 1 hour, no financials necessary, and we protect your credit score with our panel of over 30 trusted lenders.",
        textL: "Perfect for self-employed tradies, sole traders, and ABN holders. Get vehicle and machinery loans designed specifically for the trade industry.",
        images: Com,
    },
    "/vending-finance": {
        titleShort: "Build your vending empire with",
